        ...
        >
            ...
            >
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)]">
                    ...
                    <button
                        onClick={onClose}
                        className="p-1.5 text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-black rounded-full transition-colors"
                    >
                        <X className="w-4 h-4" />
                    </button>
                </div>
                ...
                <div className="p-4 border-t border-gray-100 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] bg-gray-50/50 dark:bg-[#0a0a0a]">
                    <Button
                        onClick={onLogout}
                        variant="ghost"
                        className="w-full justify-center text-red-500 hover:text-red-600 hover:bg-red-50 dark:hover:bg-black"
                    >
