    ...
    <div className="flex-[1.5] flex flex-col p-6 md:p-8 space-y-5 overflow-y-auto custom-scrollbar">
      ...
      {(locationSuggestions.length > 0 || isSearchingLocation || location) && (
        <div className="mt-4 p-3 bg-gray-50 dark:bg-[#0a0a0a] rounded-2xl border border-gray-100 dark:border-transparent dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)]">
          ...
          {location ? (
            <div className="flex items-center justify-between p-2.5 bg-white dark:bg-[#0a0a0a] border border-[#e0b596] rounded-xl">
            ...
            <div className="space-y-1.5">
              {locationSuggestions.map((place, idx) => (
                <div 
                  ...
                  className="p-2 bg-white dark:bg-[#0a0a0a] border border-gray-100 dark:border-transparent dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] rounded-xl cursor-pointer hover:border-[#e0b596]/50 hover:shadow-sm transition-all"
                >
            ...
            {allScheduleItems.map((item) => (
              item.isPreview ? (
                ...
                <div key={item.id} className="relative">
                  <div className="absolute -left-[25px] top-1 w-3.5 h-3.5 rounded-full bg-white dark:bg-[#0a0a0a] border-2 border-[#e0b596]" />
      ...
      {showCloseConfirm && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-xs bg-white dark:bg-[#0a0a0a] rounded-[1.5rem] shadow-2xl p-6 border border-gray-100 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] text-center"
          >
            <div className="w-12 h-12 bg-amber-100 dark:bg-[#0a0a0a] rounded-2xl flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
              Are you sure you want to close? Your task hasn't been created yet.
            </p>
            <div className="flex flex-col gap-2">
              ...
              <Button
                variant="ghost"
                onClick={() => setShowCloseConfirm(false)}
                className="w-full text-gray-500 font-bold h-11"
              >
                Keep Editing
              </Button>
            </div>
