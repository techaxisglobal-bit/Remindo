        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Discover stores and services in your area</p>
                </div>
            ...
            {filteredMerchants.length === 0 ? (
                <div className="text-center py-20 bg-gray-50 dark:bg-[#0a0a0a] rounded-2xl border border-dashed border-gray-200 dark:border-gray-800">
