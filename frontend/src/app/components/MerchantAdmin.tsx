...
export function MerchantAdmin() {
    ...
    const getStatusBadge = (status: string) => {
        switch (status) {
            case 'APPROVED': return <span className="px-2.5 py-1 rounded-md bg-green-50 dark:bg-[#0a0a0a] text-green-700 dark:text-green-400 text-[10px] font-bold uppercase tracking-wider border border-green-200/50 dark:border-green-800/50">Approved</span>;
            case 'PENDING': return <span className="px-2.5 py-1 rounded-md bg-orange-50 dark:bg-[#0a0a0a] text-orange-700 dark:text-orange-400 text-[10px] font-bold uppercase tracking-wider border border-orange-200/50 dark:border-orange-800/50">Pending</span>;
            case 'REJECTED': return <span className="px-2.5 py-1 rounded-md bg-red-50 dark:bg-[#0a0a0a] text-red-700 dark:text-red-400 text-[10px] font-bold uppercase tracking-wider border border-red-200/50 dark:border-red-800/50">Rejected</span>;
            default: return <span className="px-2.5 py-1 rounded-md bg-gray-50 dark:bg-[#0a0a0a] text-gray-700 dark:text-gray-300 text-[10px] font-bold uppercase tracking-wider border border-gray-200 dark:border-gray-700">{status}</span>;
        }
    };
    ...
    return (
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8 flex-shrink-0">
                ...
                <div className="flex items-center gap-3">
                    <button 
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-[#0a0a0a] border border-gray-200 dark:border-transparent dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] hover:bg-gray-50 dark:hover:bg-black text-gray-700 dark:text-gray-300 rounded-lg text-sm font-semibold transition-all shadow-sm"
                    >
            ...
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-8 flex-shrink-0">
                <div className="bg-white dark:bg-[#0a0a0a] p-5 rounded-2xl border border-gray-200 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
                    <div className="flex items-center justify-between mb-4">
                        <span className="text-xs font-bold text-gray-500 uppercase tracking-wider">Total</span>
                        <div className="w-8 h-8 rounded-full bg-blue-50 dark:bg-[#0a0a0a] flex items-center justify-center">
                ...
                <div className="bg-white dark:bg-[#0a0a0a] p-5 rounded-2xl border border-gray-200 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="w-8 h-8 rounded-full bg-orange-50 dark:bg-[#0a0a0a] flex items-center justify-center">
                ...
                <div className="bg-white dark:bg-[#0a0a0a] p-5 rounded-2xl border border-gray-200 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="w-8 h-8 rounded-full bg-green-50 dark:bg-[#0a0a0a] flex items-center justify-center">
                ...
                <div className="bg-white dark:bg-[#0a0a0a] p-5 rounded-2xl border border-gray-200 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="w-8 h-8 rounded-full bg-red-50 dark:bg-[#0a0a0a] flex items-center justify-center">
                ...
                <div className="bg-white dark:bg-[#0a0a0a] p-5 rounded-2xl border border-gray-200 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="w-8 h-8 rounded-full bg-purple-50 dark:bg-[#0a0a0a] flex items-center justify-center">
            ...
            {/* Filters Bar */}
            <div className="bg-white dark:bg-[#0a0a0a] p-2 rounded-xl border border-gray-200 dark:border-transparent dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] shadow-sm mb-6 flex flex-col md:flex-row items-center gap-2 flex-shrink-0">
                ...
                <div className="flex w-full md:w-auto gap-2">
                    <select 
                        className="flex-1 md:w-40 h-10 px-3 bg-gray-50 dark:bg-[#0a0a0a] border border-gray-200 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] rounded-lg text-sm text-gray-700 dark:text-gray-300 focus:outline-none focus:border-[#e0b596] cursor-pointer"
                        value={statusFilter}
                    ...
                    <select 
                        className="flex-1 md:w-48 h-10 px-3 bg-gray-50 dark:bg-[#0a0a0a] border border-gray-200 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] rounded-lg text-sm text-gray-700 dark:text-gray-300 focus:outline-none focus:border-[#e0b596] cursor-pointer"
            ...
            <div className="flex-1 -mx-4 px-4 sm:mx-0 sm:px-0">
                {isLoading ? (
                    <div className="space-y-3">
                        {[1, 2, 3, 4, 5].map(i => (
                            <div key={i} className="h-20 bg-white dark:bg-[#0a0a0a] border border-gray-100 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] rounded-2xl animate-pulse" />
                        ))}
                    </div>
                ) : filteredMerchants.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-20 text-center bg-gray-50 dark:bg-[#0a0a0a] rounded-2xl border border-dashed border-gray-200 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)]">
                        <div className="w-16 h-16 bg-white dark:bg-[#0a0a0a] rounded-full flex items-center justify-center mb-4 shadow-sm border border-gray-100 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)]">
                        ...
                        {(searchTerm || statusFilter !== 'ALL' || categoryFilter !== 'ALL') && (
                            <button 
                                ...
                                className="mt-4 px-4 py-2 bg-white dark:bg-[#0a0a0a] border border-gray-200 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] rounded-lg text-sm font-semibold hover:bg-gray-50 dark:hover:bg-black transition-colors shadow-sm"
                            >
                                Clear all filters
                            </button>
                        )}
                    ...
                    <div className="space-y-3 pb-8">
                        {filteredMerchants.map(merchant => (
                            <div key={merchant.id} className="flex flex-col lg:flex-row items-start lg:items-center p-4 bg-white dark:bg-[#0a0a0a] border border-gray-200 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] rounded-2xl hover:border-gray-300 dark:hover:border-[#444] transition-colors shadow-sm group gap-4">
                                        
                                        {/* Info Section */}
                                        <div className="flex items-center gap-4 w-full lg:w-[35%]">
                                            <div className="w-12 h-12 rounded-xl bg-gray-100 dark:bg-[#0a0a0a] border border-gray-200 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] flex items-center justify-center overflow-hidden flex-shrink-0">
                                                <MerchantLogo 
                                            ...
                                            <div className="min-w-0">
                                                ...
                                                <div className="flex items-center gap-2 mt-1">
                                                    <span className="text-[10px] font-bold px-2 py-0.5 rounded-md bg-gray-100 dark:bg-[#0a0a0a] text-gray-600 dark:text-gray-400 uppercase tracking-wide truncate max-w-[150px]">
                                                        {merchant.category}
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <div className="w-full lg:w-[20%] flex flex-row lg:flex-col items-center lg:items-start justify-between lg:justify-center gap-2">
                                            <div className="flex gap-2 items-center">
                                                ...
                                                {merchant.isFeatured && (
                                                    <span className="px-2.5 py-1 rounded-md bg-purple-50 dark:bg-[#0a0a0a] text-purple-700 dark:text-purple-400 text-[10px] font-bold uppercase tracking-wider border border-purple-200/50 dark:border-purple-800/50">
                                                        Featured
                                                    </span>
                                                )}
                                            </div>
                                        ...
                                        {/* Actions */}
                                        <div className="w-full lg:w-auto lg:flex-1 flex items-center justify-end gap-1.5 border-t lg:border-t-0 border-gray-100 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] pt-3 lg:pt-0">
                ...
                {selectedMerchant && (
                    <>
                        ...
                        <motion.div 
                            ...
                            className="fixed inset-y-0 right-0 w-full max-w-md bg-white dark:bg-[#0a0a0a] shadow-2xl z-50 flex flex-col border-l border-gray-200 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)]"
                        >
                            {/* Drawer Header */}
                            <div className="flex items-center justify-between p-5 border-b border-gray-200 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] bg-gray-50/50 dark:bg-[#0a0a0a]">
                                <div>
                            ...
                            <div className="flex-1 overflow-y-auto p-6 custom-scrollbar">
                                ...
                                <div className="flex items-center gap-5 mb-8">
                                    <div className="w-20 h-20 rounded-2xl bg-gray-100 dark:bg-[#0a0a0a] border border-gray-200 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] flex items-center justify-center overflow-hidden shadow-sm flex-shrink-0">
                                        <MerchantLogo 
                                ...
                                {/* Actions row */}
                                <div className="flex gap-2 mb-8 bg-gray-50 dark:bg-[#0a0a0a] p-2 rounded-xl border border-gray-100 dark:border-transparent dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)]">
                                    <button 
                                ...
                                <div className="space-y-6">
                                    <section>
                                        ...
                                        <div className="bg-gray-50 dark:bg-[#0a0a0a] rounded-xl p-4 border border-gray-100 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)]">
                                    ...
                                    <section>
                                        ...
                                        <div className="bg-white dark:bg-[#0a0a0a] rounded-xl border border-gray-200 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] divide-y divide-gray-100 dark:divide-[#333]">
                                            <div className="p-3 flex items-center gap-3">
                                                <div className="w-8 h-8 rounded-lg bg-gray-50 dark:bg-[#0a0a0a] flex items-center justify-center"><Phone className="w-4 h-4 text-gray-500" /></div>
                                            ...
                                            <div className="p-3 flex items-center gap-3">
                                                <div className="w-8 h-8 rounded-lg bg-gray-50 dark:bg-[#0a0a0a] flex items-center justify-center"><Mail className="w-4 h-4 text-gray-500" /></div>
                                                <div className="min-w-0 flex-1">
                                            ...
                                            <div className="p-3 flex items-center gap-3">
                                                <div className="w-8 h-8 rounded-lg bg-gray-50 dark:bg-[#0a0a0a] flex items-center justify-center"><Globe className="w-4 h-4 text-gray-500" /></div>
                                                <div className="min-w-0 flex-1">
                                            ...
                                            <div className="p-3 flex items-center gap-3">
                                                <div className="w-8 h-8 rounded-lg bg-gray-50 dark:bg-[#0a0a0a] flex items-center justify-center"><Map className="w-4 h-4 text-gray-500" /></div>
                                                <div className="min-w-0 flex-1">
                                    ...
                                    <section>
                                        ...
                                        <div className="bg-gray-50 dark:bg-[#0a0a0a] rounded-xl border border-gray-100 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] p-4 text-sm flex items-center justify-between">
                                            {selectedMerchant.proofDocumentUrl ? (
                                                <>
                                                    <div className="flex items-center gap-3">
                                                        <div className="w-10 h-10 rounded-lg bg-blue-50 dark:bg-[#0a0a0a] flex items-center justify-center">
                                                    ...
                                                    <a 
                                                        ...
                                                        target="_blank" 
                                                        rel="noreferrer" 
                                                        className="px-4 py-2 bg-white dark:bg-[#0a0a0a] hover:bg-gray-50 dark:hover:bg-black border border-gray-200 dark:border-[#444] rounded-lg text-sm font-semibold transition-colors shadow-sm"
                                                    >
                                                        View
                                                    </a>
                                                </>
