  ...
  return (
    <div className="relative flex-1" ref={ref}>
      <button
        ...
        className={`w-full text-left text-[13px] font-bold focus:outline-none whitespace-nowrap transition-colors bg-gray-50/50 dark:bg-black px-3 py-2 rounded-2xl flex items-center justify-between group border border-gray-100 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] shadow-sm active:scale-[0.98] transition-all
      ...
      <AnimatePresence>
        {show && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-1.5 p-1 bg-white dark:bg-[#0a0a0a] border border-gray-200 dark:border-transparent dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] rounded-[1rem] shadow-2xl z-50 min-w-max"
          >
            <DayPicker
              mode="single"
              selected={parsedDate}
  ...
  return (
    <div className="relative flex-1" ref={ref}>
      <button
        ...
        disabled={disabled}
        onClick={() => !disabled && setShow(!show)}
        className={`w-full text-left text-[13px] font-bold focus:outline-none whitespace-nowrap bg-gray-50/50 dark:bg-black px-3 py-2 rounded-2xl flex items-center justify-between group border border-gray-100 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] shadow-sm active:scale-[0.98] transition-all
          ${disabled ? 'cursor-not-allowed opacity-50' : 'hover:border-[#e0b596]/30 hover:text-[#e0b596]'}`}
      >
      ...
      <AnimatePresence>
        {show && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0, scale: 1 }}
            exit={{ opacity: 0, y: 5, scale: 0.98 }}
            className="absolute top-full left-0 mt-1.5 p-1.5 bg-white dark:bg-[#0a0a0a] border border-gray-200 dark:border-transparent dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] rounded-[1rem] shadow-2xl z-50 flex flex-col gap-1.5 w-[120px]"
          >
            <div className="flex items-center justify-center h-28 relative bg-gray-50 dark:bg-[#0a0a0a] rounded-lg overflow-hidden border border-gray-100 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)]">
              {/* Highlight Overlay */}
  ...
  return (
    ...
    >
      ...
      >
              ...
              <AnimatePresence>
                {showMoreOptions && (
                  ...
                  >
                    ...
                    <div className="flex items-start gap-2 bg-gray-50 dark:bg-[#0a0a0a] px-3 py-2 rounded-2xl border border-gray-100 dark:border-transparent dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] shadow-sm">
            ...
            <div className="space-y-5">
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {isSpecial && (
                    <Badge className="bg-orange-100 text-orange-700 dark:bg-[#0a0a0a] dark:text-orange-400 border-none px-2 py-0.5 flex items-center gap-1">
              ...
              <div className="space-y-2">
                {/* Start Row */}
                <div className="flex items-center gap-2">
                  <div className="flex-[1.8] flex items-center gap-2 bg-gray-50/50 dark:bg-[#0a0a0a] px-3 py-2 rounded-2xl border border-gray-100 dark:border-transparent dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] shadow-sm">
                  ...
                  <div className="flex-1 flex items-center gap-2 bg-gray-50/50 dark:bg-[#0a0a0a] px-3 py-2 rounded-2xl border border-gray-100 dark:border-transparent dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] shadow-sm">
                    <Clock className="w-3.5 h-3.5 text-[#e0b596]" />
              ...
              <AnimatePresence>
                {true && (
                  ...
                  >
                    <div className="flex items-start gap-2 bg-gray-50/50 dark:bg-[#0a0a0a] px-3 py-2 rounded-2xl border border-gray-100 dark:border-transparent dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] shadow-sm">
              ...
              {!isEditing && localTask.attendees && localTask.attendees.length > 0 && (
                <div className="space-y-3 mt-4 pt-4 border-t border-gray-100 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)]">
                  <h3 className="text-[12px] font-bold text-gray-400 uppercase tracking-wider flex items-center justify-between">
                    Invited Attendees
                    <Badge className="bg-gray-100 text-gray-500 dark:bg-[#0a0a0a] dark:text-gray-400 border-none">{localTask.attendees.length}</Badge>
                  </h3>
                  <div className="flex flex-col gap-3">
                    {(localTask.attendees as any[]).map((attendee, idx) => {
                      ...
                      switch(status) {
                        case 'Accepted': statusBadge = <Badge className="bg-green-100 text-green-700 dark:bg-[#0a0a0a] dark:text-green-400 border-none px-2 py-0.5 text-[10px]">🟢 Accepted</Badge>; break;
                        case 'Declined': statusBadge = <Badge className="bg-red-100 text-red-700 dark:bg-[#0a0a0a] dark:text-red-400 border-none px-2 py-0.5 text-[10px]">🔴 Declined</Badge>; break;
                        case 'Expired': statusBadge = <Badge className="bg-gray-100 text-gray-700 dark:bg-[#0a0a0a] dark:text-gray-400 border-none px-2 py-0.5 text-[10px]">⚪ Expired</Badge>; break;
                        default: statusBadge = <Badge className="bg-orange-100 text-orange-700 dark:bg-[#0a0a0a] dark:text-orange-400 border-none px-2 py-0.5 text-[10px]">🟠 Pending</Badge>;
                      }

                      return (
                        <div key={idx} className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white dark:bg-[#0a0a0a] p-3 rounded-2xl border border-gray-100 dark:border-transparent dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] shadow-sm hover:border-gray-200 dark:hover:border-transparent dark:hover:bg-[#111] transition-all group">
        ...
        <div className="hidden md:flex flex-1 max-w-[240px] bg-gray-50 dark:bg-[#0a0a0a] border-l border-gray-200 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] flex-col">
          <div className="p-5 border-b border-gray-200 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] flex items-center justify-between">
            <div className="flex items-center gap-2">
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-4 custom-scrollbar">
            {allScheduleItems.length > 0 ? (
              <div className="relative pl-5 border-l-2 border-gray-200 dark:border-white/[0.04] dark:shadow-[0_2px_8px_rgba(0,0,0,0.5)] space-y-8">
              ...
              <div className="h-full flex flex-col items-center justify-center text-center space-y-4 opacity-40">
                <div className="w-14 h-14 bg-gray-200 dark:bg-[#0a0a0a] rounded-2xl flex items-center justify-center">
