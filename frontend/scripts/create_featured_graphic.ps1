...
$outPath = "d:\Pictures - Copy\Desktop\New folder (5)\Remindo\Remindo\frontend\assets\featured_graphic.png"
...
Write-Output "Featured graphic created at $outPath"
